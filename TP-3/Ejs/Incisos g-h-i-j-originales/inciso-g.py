...
class StereoTriangulationNode(Node):
    def __init__(self, left_yaml, right_yaml):
        ...
        # --- Ground-truth ---
        self.current_pose = np.eye(4)  # Pose en matriz 4x4
        ...
        # --- Stereo matcher para mapa de disparidad ---
        self.num_disparities = 64  # múltiplo de 16
        self.block_size = 15
    ...
    def callback(self, msg_l, msg_r):
        ...
        """ # --- Feature Matching y triangulación ---
